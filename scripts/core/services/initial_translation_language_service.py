...
def run_language_translation(
    *,
    ...
    source_context_overlap: int = 0, context_selection: Optional[Any] = None,
) -> None:
    ...
    processor = _build_parallel_processor(max_workers, effective_chunk_size, source_context_overlap, context_selection)
