...
export const PAGE_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    navigation: { entryMode: ENTRY_MODES.PRIMARY, section: 'quality', label: 'mod_archive.title', icon: 'sparkles', order: 30 },
    tutorialContext: 'mod-archive-analysis',
    guide: 'docs/zh/user-guides/mod-archive.md',
    copilot: { pageName: '模组档案馆 / Mod Archive', helpSkillId: 'neologism_tribunal' },
  },
  {
    id: 'agent-workshop',
