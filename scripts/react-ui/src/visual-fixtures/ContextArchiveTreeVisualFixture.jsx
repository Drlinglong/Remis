...
import archiveStyles from '../components/neologism/ModArchive.module.css';
...
export default function ContextArchiveTreeVisualFixture() {
    return (
        ...
        >
            <Box
                className={`${archiveStyles.page} ${archiveStyles.publishedContextPage}`}
                data-testid="published-context-layout"
            >
