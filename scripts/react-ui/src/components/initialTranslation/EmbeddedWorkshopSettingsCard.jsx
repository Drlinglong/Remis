...
export default function EmbeddedWorkshopSettingsCard({
  ...
  return (
    <CollapsibleSettingsCard
      ...
      t={t}
      title={t('translation_page.embedded_workshop_settings', { defaultValue: '格式修复台设置' })}
      ...
      action={(
        <Switch
          ...
          label={t('translation_page.embedded_workshop_enabled', { defaultValue: '在翻译工作流中嵌入格式修复台' })}
              ...
              <Box style={{ flex: 1 }}>
                {renderNativeSelect({
                  label: renderInfoLabel(
                    ...
                    t('translation_page.embedded_workshop_batch_size_tooltip', { defaultValue: '控制格式修复台每批修复的问题数量。只对本次翻译生效。' }),
                  ),
              ...
              <Box style={{ flex: 1 }}>
                {renderNativeSelect({
                  label: renderInfoLabel(
                    ...
                    t('translation_page.embedded_workshop_concurrency_tooltip', { defaultValue: '控制格式修复台同时修复多少个批次。只对本次翻译生效。' }),
                  ),
              ...
              <Box style={{ flex: 1 }}>
                {renderNativeSelect({
                  label: renderInfoLabel(
                    ...
                    t('translation_page.embedded_workshop_rpm_tooltip', { defaultValue: '限制格式修复台每分钟请求数。只对本次翻译生效。' }),
                  ),
